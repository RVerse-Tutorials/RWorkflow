...
This week I will give an introduction to plotting with ggplot. Getting a basic familiarity with ggplot will really save you a lot of time that you spend futzing with plots. 
...
This material was covered in the NWFSC workshop sessions:

* [2020 Video](https://youtu.be/odCam8JxvKI)

## Set-up

You will need to install the ggplot2 and gridExtra packages for this session.
...
p2 <- p1 + geom_point() # Tell it what to do with that (add points)
p2 # plot it
```
...
With `ggplot()`, the approach is quite different and the names are mostly totally different. A cheatsheet of things you commonly use will be helpful when starting out (I still use one).
